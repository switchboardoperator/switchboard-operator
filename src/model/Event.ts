...
export default class Event {
  ...
  get baseQueueName() {
    return `${this.prefix}.${this.name}.${this.eventName}`
  }

  getQueueName() {
    return `${this.baseQueueName}.${this.route}`
  }

  getDeadLetterEx() {
    // Rabbot automatically appends route to deadLetters
    return `${this.baseQueueName}.dead-letter`
  }
